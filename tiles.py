...
class Soil(Tile):
    ...
    def __init__(self):
        path_soil = join("assets", "Race-Track-Tile-Set-PNG",
                         "PNG", "Background_Tiles")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_soil, "Soil_Tile.png")), (background_tile_size, background_tile_size)))


class Road_02_01(Tile):

    def __init__(self):
        path_road_02_01 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_01")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_01,  "Road_02_Tile_01.png")), (road_size, road_size)))


class Road_02_02(Tile):

    def __init__(self):
        path_road_02_02 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_02")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_02,  "Road_02_Tile_02.png")), (road_size, road_size)))


class Road_02_03(Tile):

    def __init__(self):
        path_road_02_03 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_03")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_03,  "Road_02_Tile_03.png")), (road_size, road_size)))


class Road_02_04(Tile):

    def __init__(self):
        path_road_02_04 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_04")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_04,  "Road_02_Tile_04.png")), (road_size, road_size)))


class Road_02_05(Tile):

    def __init__(self):
        path_road_02_05 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_05")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_05,  "Road_02_Tile_05.png")), (road_size, road_size)))


class Road_02_06(Tile):

    def __init__(self):
        path_road_02_06 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_06")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_06,  "Road_02_Tile_06.png")), (road_size, road_size)))


class Road_02_07(Tile):

    def __init__(self):
        path_road_02_07 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_07")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_07,  "Road_02_Tile_07.png")), (road_size, road_size)))


class Road_02_08(Tile):

    def __init__(self):
        path_road_02_08 = join(
            "assets", "Race-Track-Tile-Set-PNG", "PNG", "Road_02", "Road_02_Tile_08")
        Tile.__init__(self,  pg.transform.scale(pg.image.load(
            join(path_road_02_08,  "Road_02_Tile_08.png")), (road_size, road_size)))
...
def load_map(map_number):
    ...
    with open(join(path_map, map_number), "r") as myfile:  # Open json file
        data = myfile.read()
        obj = json.loads(data)
        # Load background , map and collisions on different threads
